...
import 'package:todo_dart_vaden/config/app_configuration.dart';
import 'package:todo_dart_vaden/config/database/drift_configuration.dart';
import 'package:todo_dart_vaden/config/health_controller.dart';
import 'package:todo_dart_vaden/config/middleware/cors_configuration.dart';
import 'package:todo_dart_vaden/config/openapi/openapi_configuration.dart';
import 'package:todo_dart_vaden/config/openapi/openapi_controller.dart';
...
import 'package:todo_dart_vaden/src/controllers/auth_controller.dart';
import 'package:todo_dart_vaden/src/controllers/todo_controller.dart';
import 'package:todo_dart_vaden/src/controllers/user_controller.dart';
import 'package:todo_dart_vaden/src/data/repositories/todo_repository_impl.dart';
import 'package:todo_dart_vaden/src/data/repositories/user_repository_impl.dart';
import 'package:todo_dart_vaden/src/dto/auth_dto.dart';
import 'package:todo_dart_vaden/src/dto/common_dto.dart';
import 'package:todo_dart_vaden/src/dto/todo_dto.dart';
import 'package:todo_dart_vaden/src/dto/user_dto.dart';
import 'package:todo_dart_vaden/src/services/auth_service.dart';
import 'package:todo_dart_vaden/src/services/user_details_service.dart';
...
class VadenApp implements DartVadenApplication {
  ...
  Future<void> setup() async {
    ...
    _injector.addLazySingleton(
      configurationSecurityConfiguration.passwordEncoder,
    );
    ...
    var pipelineHealthControllerhealth = const Pipeline();
    ...
    routerHealthController.get(
      '/health',
      pipelineHealthControllerhealth.addHandler(handlerHealthControllerhealth),
    );
    ...
    paths['/auth/me']['get']['responses']['403'] = {
      'description': 'Forbidden',
      'content': <String, dynamic>{},
    };

    paths['/auth/me']['get']['responses']['403']['content']['application/json'] =
        <String, dynamic>{};

    paths['/auth/me']['get']['responses']['403']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/VadenSecurityError'};

    paths['/auth/me']['get']['responses']['400'] = {
      'description': 'Bad request',
      'content': <String, dynamic>{},
    };

    paths['/auth/me']['get']['responses']['400']['content']['application/json'] =
        <String, dynamic>{};
    ...
    paths['/auth/me']['get']['responses']['500']['content']['application/json'] =
        <String, dynamic>{};

    paths['/auth/me']['get']['responses']['500']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/VadenSecurityError'};

    paths['/auth/me']['get']['responses']['401'] = {
      'description': 'Unauthorized',
      'content': <String, dynamic>{},
    };

    paths['/auth/me']['get']['responses']['401']['content']['application/json'] =
        <String, dynamic>{};

    paths['/auth/me']['get']['responses']['401']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/VadenSecurityError'};

    var pipelineAuthControllerme = const Pipeline();
    ...
    routerAuthController.get(
      '/me',
      pipelineAuthControllerme.addHandler(handlerAuthControllerme),
    );
    ...
    paths['/auth/login']['get']['responses']['200']['content']['application/json'] =
        <String, dynamic>{};

    paths['/auth/login']['get']['responses']['200']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/Tokenization'};

    paths['/auth/login']['get']['responses']['403'] = {
      'description': 'Forbidden',
      'content': <String, dynamic>{},
    };

    paths['/auth/login']['get']['responses']['403']['content']['application/json'] =
        <String, dynamic>{};

    paths['/auth/login']['get']['responses']['403']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/VadenSecurityError'};

    paths['/auth/login']['get']['responses']['400'] = {
      'description': 'Bad request',
      'content': <String, dynamic>{},
    };

    paths['/auth/login']['get']['responses']['400']['content']['application/json'] =
        <String, dynamic>{};
    ...
    paths['/auth/login']['get']['responses']['500']['content']['application/json'] =
        <String, dynamic>{};

    paths['/auth/login']['get']['responses']['500']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/VadenSecurityError'};

    paths['/auth/login']['get']['responses']['401'] = {
      'description': 'Unauthorized',
      'content': <String, dynamic>{},
    };

    paths['/auth/login']['get']['responses']['401']['content']['application/json'] =
        <String, dynamic>{};
    ...
    paths['/auth/refresh']['get']['summary'] =
    ...
    paths['/auth/refresh']['get']['responses']['200']['content']['application/json'] =
        <String, dynamic>{};

    paths['/auth/refresh']['get']['responses']['200']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/Tokenization'};

    paths['/auth/refresh']['get']['responses']['403'] = {
      'description': 'Forbidden',
      'content': <String, dynamic>{},
    };

    paths['/auth/refresh']['get']['responses']['403']['content']['application/json'] =
        <String, dynamic>{};

    paths['/auth/refresh']['get']['responses']['403']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/VadenSecurityError'};

    paths['/auth/refresh']['get']['responses']['400'] = {
      'description': 'Bad request',
      'content': <String, dynamic>{},
    };

    paths['/auth/refresh']['get']['responses']['400']['content']['application/json'] =
        <String, dynamic>{};
    ...
    paths['/auth/refresh']['get']['responses']['500']['content']['application/json'] =
        <String, dynamic>{};

    paths['/auth/refresh']['get']['responses']['500']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/VadenSecurityError'};

    paths['/auth/refresh']['get']['responses']['401'] = {
      'description': 'Unauthorized',
      'content': <String, dynamic>{},
    };

    paths['/auth/refresh']['get']['responses']['401']['content']['application/json'] =
        <String, dynamic>{};

    paths['/auth/refresh']['get']['responses']['401']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/VadenSecurityError'};

    var pipelineAuthControllerrefresh = const Pipeline();
    ...
    routerAuthController.get(
      '/refresh',
      pipelineAuthControllerrefresh.addHandler(handlerAuthControllerrefresh),
    );
    ...
    var pipelineAppAuthControllerregister = const Pipeline();
    ...
    final handlerAppAuthControllerregister = (Request request) async {
      ...
      final data =
          _injector.get<DSON>().fromJson<RegisterRequest>(bodyJson) as dynamic;

      if (data == null) {
        return Response(
          400,
          body: jsonEncode({'error': 'Invalid body: (RegisterRequest)'}),
        );
      }
    ...
    routerAppAuthController.post(
      '/register',
      pipelineAppAuthControllerregister.addHandler(
        handlerAppAuthControllerregister,
      ),
    );
    paths['/auth/login'] = <String, dynamic>{
      ...paths['/auth/login'] ?? <String, dynamic>{},
    ...
    var pipelineAppAuthControllerlogin = const Pipeline();
    ...
    final handlerAppAuthControllerlogin = (Request request) async {
      ...
      final bodyJson = jsonDecode(bodyString) as Map<String, dynamic>;
      final loginData =
          _injector.get<DSON>().fromJson<LoginRequest>(bodyJson) as dynamic;

      if (loginData == null) {
        return Response(
          400,
          body: jsonEncode({'error': 'Invalid body: (LoginRequest)'}),
        );
      }
    ...
    routerAppAuthController.post(
      '/login',
      pipelineAppAuthControllerlogin.addHandler(handlerAppAuthControllerlogin),
    );
    ...
    paths['/api/todos/']['get']['responses']['200']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/TodoPaginatedResponse'};
    ...
    var pipelineTodoControllerlistTodos = const Pipeline();
    ...
    final handlerTodoControllerlistTodos = (Request request) async {
      if (request.context['user'] == null) {
        return Response(
          400,
          body: jsonEncode({'error': 'Context is required (user)'}),
        );
      }
      ...
      final result = await ctrl.listTodos(
        currentUser,
        page,
        limit,
        search,
      ...
      final jsoResponse = _injector.get<DSON>().toJson<TodoPaginatedResponse>(
        result,
      );
      return Response.ok(
        jsonEncode(jsoResponse),
    ...
    routerTodoController.get(
      '/',
      pipelineTodoControllerlistTodos.addHandler(
        handlerTodoControllerlistTodos,
      ),
    );
    ...
    paths['/api/todos/{id}']['get']['description'] =
    ...
    paths['/api/todos/{id}']['get']['responses']['200']['content']['application/json'] =
        <String, dynamic>{};

    paths['/api/todos/{id}']['get']['responses']['200']['content']['application/json']['schema'] =
        {'\$ref': '#/components/schemas/TodoProfile'};
    ...
    var pipelineTodoControllergetTodoById = const Pipeline();
    ...
    final handlerTodoControllergetTodoById = (Request request) async {
      if (request.params['id'] == null) {
        return Response(
          400,
          body: jsonEncode({'error': 'Path Param is required (id)'}),
        );
      }
      final todoId = _parse<int>(request.params['id'])!;
    ...
    routerTodoController.get(
      '/<id>',
      pipelineTodoControllergetTodoById.addHandler(
        handlerTodoControllergetTodoById,
      ),
    );
    paths['/api/todos/'] = <String, dynamic>{
      ...paths['/api/todos/'] ?? <String, dynamic>{},
    ...
    paths['/api/todos/']['post']['responses']['201']['content']['application/json'] =
        <String, dynamic>{};
    ...
    var pipelineTodoControllercreateTodo = const Pipeline();
    ...
    final handlerTodoControllercreateTodo = (Request request) async {
      ...
      final bodyJson = jsonDecode(bodyString) as Map<String, dynamic>;
      final data =
          _injector.get<DSON>().fromJson<CreateTodoRequest>(bodyJson)
              as dynamic;

      if (data == null) {
        return Response(
          400,
          body: jsonEncode({'error': 'Invalid body: (CreateTodoRequest)'}),
        );
      }
    ...
    routerTodoController.post(
      '/',
      pipelineTodoControllercreateTodo.addHandler(
        handlerTodoControllercreateTodo,
      ),
    );
    paths['/api/todos/{id}'] = <String, dynamic>{
      ...paths['/api/todos/{id}'] ?? <String, dynamic>{},
    ...
    paths['/api/todos/{id}']['put']['description'] =
        'Update todo information (title, description, completed status)';
    paths['/api/todos/{id}']['put']['responses']['200'] = {
      'description': 'Todo updated successfully',
      'content': <String, dynamic>{},
    };

    paths['/api/todos/{id}']['put']['responses']['200']['content']['application/json'] =
        <String, dynamic>{};
    ...
    var pipelineTodoControllerupdateTodo = const Pipeline();
    ...
    final handlerTodoControllerupdateTodo = (Request request) async {
      ...
      final bodyJson = jsonDecode(bodyString) as Map<String, dynamic>;
      final updateData =
          _injector.get<DSON>().fromJson<UpdateTodoRequest>(bodyJson)
              as dynamic;

      if (updateData == null) {
        return Response(
          400,
          body: jsonEncode({'error': 'Invalid body: (UpdateTodoRequest)'}),
        );
      }

      if (updateData is Validator<UpdateTodoRequest>) {
        final validator = updateData.validate(
          ValidatorBuilder<UpdateTodoRequest>(),
        );
        final resultValidator = validator.validate(
          updateData as UpdateTodoRequest,
        );
        if (!resultValidator.isValid) {
          throw ResponseException<List<Map<String, dynamic>>>(
            400,
    ...
    routerTodoController.put(
      '/<id>',
      pipelineTodoControllerupdateTodo.addHandler(
        handlerTodoControllerupdateTodo,
      ),
    );
    paths['/api/todos/{id}'] = <String, dynamic>{
      ...paths['/api/todos/{id}'] ?? <String, dynamic>{},
    ...
    paths['/api/todos/{id}']['delete']['description'] =
    ...
    paths['/api/todos/{id}']['delete']['responses']['200']['content']['application/json'] =
        <String, dynamic>{};
    ...
    var pipelineTodoControllerdeleteTodo = const Pipeline();
    ...
    routerTodoController.delete(
      '/<id>',
      pipelineTodoControllerdeleteTodo.addHandler(
        handlerTodoControllerdeleteTodo,
      ),
    );
    ...
    paths['/api/users/']['get']['description'] =
    ...
    var pipelineUserControllerlistUsers = const Pipeline();
    ...
    final handlerUserControllerlistUsers = (Request request) async {
      ...
      final jsoResponse = _injector.get<DSON>().toJson<UserPaginatedResponse>(
        result,
      );
      return Response.ok(
        jsonEncode(jsoResponse),
    ...
    routerUserController.get(
      '/',
      pipelineUserControllerlistUsers.addHandler(
        handlerUserControllerlistUsers,
      ),
    );
    ...
    paths['/api/users/{id}']['get']['description'] =
    ...
    var pipelineUserControllergetUserById = const Pipeline();
    ...
    final handlerUserControllergetUserById = (Request request) async {
      ...
      final userId = _parse<int>(request.params['id'])!;
    ...
    routerUserController.get(
      '/<id>',
      pipelineUserControllergetUserById.addHandler(
        handlerUserControllergetUserById,
      ),
    );
    paths['/api/users/'] = <String, dynamic>{
      ...paths['/api/users/'] ?? <String, dynamic>{},
    ...
    paths['/api/users/']['post']['description'] =
    ...
    var pipelineUserControllercreateUser = const Pipeline();
    ...
    final handlerUserControllercreateUser = (Request request) async {
      ...
      final bodyJson = jsonDecode(bodyString) as Map<String, dynamic>;
      final data =
          _injector.get<DSON>().fromJson<CreateUserRequest>(bodyJson)
              as dynamic;

      if (data == null) {
        return Response(
          400,
          body: jsonEncode({'error': 'Invalid body: (CreateUserRequest)'}),
        );
      }
    ...
    routerUserController.post(
      '/',
      pipelineUserControllercreateUser.addHandler(
        handlerUserControllercreateUser,
      ),
    );
    paths['/api/users/{id}'] = <String, dynamic>{
      ...paths['/api/users/{id}'] ?? <String, dynamic>{},
    ...
    paths['/api/users/{id}']['put']['description'] =
    ...
    var pipelineUserControllerupdateUser = const Pipeline();
    ...
    final handlerUserControllerupdateUser = (Request request) async {
      ...
      final bodyJson = jsonDecode(bodyString) as Map<String, dynamic>;
      final updateData =
          _injector.get<DSON>().fromJson<UpdateUserRequest>(bodyJson)
              as dynamic;

      if (updateData == null) {
        return Response(
          400,
          body: jsonEncode({'error': 'Invalid body: (UpdateUserRequest)'}),
        );
      }

      if (updateData is Validator<UpdateUserRequest>) {
        final validator = updateData.validate(
          ValidatorBuilder<UpdateUserRequest>(),
        );
        final resultValidator = validator.validate(
    ...
    routerUserController.put(
      '/<id>',
      pipelineUserControllerupdateUser.addHandler(
        handlerUserControllerupdateUser,
      ),
    );
    paths['/api/users/{id}'] = <String, dynamic>{
      ...paths['/api/users/{id}'] ?? <String, dynamic>{},
    ...
    paths['/api/users/{id}']['delete']['description'] =
    ...
    var pipelineUserControllerdeleteUser = const Pipeline();
    ...
    routerUserController.delete(
      '/<id>',
      pipelineUserControllerdeleteUser.addHandler(
        handlerUserControllerdeleteUser,
      ),
    );
...
class _DSON extends DSON {
  ...
  getMaps() {
    ...
    fromJsonMap[UserDetails] = (Map<String, dynamic> json) {
      return Function.apply(UserDetails.new, [], {
    ...
    fromJsonMap[VadenSecurityError] = (Map<String, dynamic> json) {
      return Function.apply(VadenSecurityError.new, [json['error']], {});
    };
    ...
    fromJsonMap[RegisterRequest] = (Map<String, dynamic> json) {
      return Function.apply(RegisterRequest.new, [], {
    ...
    fromJsonMap[LoginRequest] = (Map<String, dynamic> json) {
      return Function.apply(LoginRequest.new, [], {
        #email: json['email'],
        #password: json['password'],
      });
    };
    ...
    fromJsonMap[AuthResponse] = (Map<String, dynamic> json) {
      return Function.apply(AuthResponse.new, [], {
        #token: json['token'],
    ...
    fromJsonMap[UserAuthProfile] = (Map<String, dynamic> json) {
      return Function.apply(UserAuthProfile.new, [], {
        #id: json['id'],
        #email: json['email'],
        #firstName: json['firstName'],
        #lastName: json['lastName'],
    ...
    fromJsonMap[StatusResponse] = (Map<String, dynamic> json) {
      return Function.apply(StatusResponse.new, [], {
    ...
    fromJsonMap[TodoProfile] = (Map<String, dynamic> json) {
      return Function.apply(TodoProfile.new, [], {
        #id: json['id'],
        #userId: json['userId'],
        #title: json['title'],
    ...
    fromJsonMap[CreateTodoRequest] = (Map<String, dynamic> json) {
      return Function.apply(CreateTodoRequest.new, [], {
        #title: json['title'],
        #description: json['description'],
      });
    };
    ...
    fromJsonMap[UpdateTodoRequest] = (Map<String, dynamic> json) {
      return Function.apply(UpdateTodoRequest.new, [], {
        #title: json['title'],
        #description: json['description'],
        #completed: json['completed'],
      });
    ...
    fromJsonMap[TodoPaginatedResponse] = (Map<String, dynamic> json) {
      return Function.apply(TodoPaginatedResponse.new, [], {
    ...
    fromJsonMap[UserProfile] = (Map<String, dynamic> json) {
      return Function.apply(UserProfile.new, [], {
        #id: json['id'],
        #firstName: json['firstName'],
        #lastName: json['lastName'],
        #email: json['email'],
    ...
    fromJsonMap[UserPaginatedResponse] = (Map<String, dynamic> json) {
      return Function.apply(UserPaginatedResponse.new, [], {
    ...
    fromJsonMap[CreateUserRequest] = (Map<String, dynamic> json) {
      return Function.apply(CreateUserRequest.new, [], {
        #firstName: json['firstName'],
        #lastName: json['lastName'],
        #email: json['email'],
        #password: json['password'],
    ...
    fromJsonMap[UpdateUserRequest] = (Map<String, dynamic> json) {
      return Function.apply(UpdateUserRequest.new, [], {
        #firstName: json['firstName'],
        #lastName: json['lastName'],
        #email: json['email'],
        #roles: json['roles'] == null ? null : json['roles'].cast<String>(),
      });
    };
    ...
    fromJsonMap[CustomUserDetails] = (Map<String, dynamic> json) {
      return Function.apply(CustomUserDetails.new, [], {
        #id: json['id'],
        #username: json['username'],
        #password: json['password'],
        #roles: json['roles'].cast<String>(),
    ...
    toJsonMap[CustomUserDetails] = (object) {
      ...
      return {'id': obj.id, 'username': obj.username, 'roles': obj.roles};
    };
